...
// Known Bugs: The reader can only handle STL facets with three vertices and specific headings as provided by OpenSCAD. It is unclear whether or not every STL file generated by other programs will use the same format
